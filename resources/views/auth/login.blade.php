            ...
            <div class="row bs-reset">
                <div class="col-md-6 login-container bs-reset">
                    ...
                    <div class="login-content">
                        <h1><b>Medic Plus  Login</b></h1>
						<hr>
                        <p> Kindly Enter <span class="text-success bold">Username</span> or <span class="text-success bold">Email Address</span> you Provided During Registration. If you are not able to login, Please contact your system admin, To Upload your hospital invoice follow this link <a href="/Uploadreceipt/docuploads" class="text-danger bold" >Upload Receipt/Invoice scanned documents</a> If you don't have an account <a href="/register"><b>Register</b></a></p>
                        <form action="{{ route('login') }}"  class="login-form" method="post">
                            ...
                            <div class="row">
                                <div class="col-xs-6">
                                    <input class="form-control form-control-solid placeholder-no-fix form-group" type="text" autocomplete="off" placeholder="Email Address" name="email" required/> 
										@if ($errors->has('email'))
                        ...
                        <div class="row bs-reset">
                            ...
                            <div class="col-xs-7 bs-reset">
                                <div class="login-copyright text-right">
                                    <p><b>Copyright &copy; Fortune Consulting Limited {{ date('Y')}}</b></p>
                                </div>
                            </div>
                        </div>
                    </div>
