...
<html lang="en">
    ...
    <body class=" login">
        ...
        <div class="logo">
            <a href="#">
                <img src="{{ asset('assets/layouts/layout4/img/medic.png') }}"  alt="" /> </a>
        </div>
        <!-- END LOGO -->
        <!-- BEGIN LOGIN -->
         <div class="content">
            ...
            <form class="login-form" action="{{ route('login') }}" method="post">
                ...
                <div class="alert alert-danger display-hide">
                    ...
                    <span> Enter any Emaill Address and password. </span>
                </div>
        ...
        <div class="copyright hide"> 2019 ©Fortune Consulting LTD. </div>
        <!-- END LOGIN -->
        <!--[if lt IE 9]>
