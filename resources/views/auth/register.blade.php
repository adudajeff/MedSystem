...
<html lang="en">
   ...
   <div class="container">
    <div class="row">
        <div class="col-md-8 col-md-offset-2" style="padding-top:100px !important;">
            <div class="panel panel-default" >
			     <div class=""><center> <img class="login-logo login-6" src="{{ asset('assets/layouts/layout4/img/medic.png') }}" /></center></div>
                        ...
                        <div class="form-group">
                            <div class="col-md-6 col-md-offset-4">
                                <button type="submit" class="btn btn-primary">
								 ...
								 <a href="/login" id="login" class="login">Login?</a>
                            </div>
                        </div>
                    </form>
                </div>
